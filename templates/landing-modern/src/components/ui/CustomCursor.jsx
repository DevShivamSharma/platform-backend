...
const { effects, fonts, labels } = templateConfig.theme;
  ...
  useEffect(() => {
    ...
    const handleEnter = (event) => {
      ...
      if (type === 'project') {
        ...
        setLabel(labels.cursorProject);
      } else if (type === 'drag') {
        gsap.to(ring, { scale: 2.6, duration: 0.4, ease: 'power3.out', overwrite: 'auto' });
        setLabel(labels.cursorDrag);
      } else {
    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          height: 34,
          borderRadius: '50%',
          border: `1px solid ${effects.cursorRing}`,
          willChange: 'transform',
        }}
      >
        <span

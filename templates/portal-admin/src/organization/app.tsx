...
import { legacyRoutesEnabled, portalConfig } from "@/lib/portal-config"
import "@/index.css"
...
const GeneratedCrudPage = lazy(() => import("@organization/pages/generated-crud/page"))
...
function OrganizationApp() {
    ...
    useActivityTracker()
    const legacyRoutes = legacyRoutesEnabled()

    return (
        <ErrorBoundary>
            <QueryProvider>
            <ThemeProvider defaultTheme={portalConfig.theme?.mode || "system"}>
                <ToastProvider>
                    <MobileBlocker>
                        <BrowserRouter>
                            <GlobalLoader />
                            <Suspense fallback={<SuspenseLoader source="organization-app" message="Loading..." />}>
                                <Routes>
                                    ...
                                    <Route element={<OrganizationAuthGuard><SuspenseRoute><OrganizationLayout /></SuspenseRoute></OrganizationAuthGuard>}>
                                        ...
                                        <Route path="/organization/crud/:moduleId" element={<SuspenseRoute><GeneratedCrudPage /></SuspenseRoute>} />
                                    </Route>

...
import { getPortalDisplayName, portalConfig } from "@/lib/portal-config"
...
export function AcknowledgementModal({ isOpen, onAcknowledged }: AcknowledgementModalProps) {
    ...
    const supportEmail = portalConfig.company?.supportEmail || "support@example.com"
            ...
            >
                ...
                <div className="flex-1 overflow-y-auto px-6 py-5">
                    <div className="bg-brand/5 border-l-[3px] border-brand rounded-r-lg px-4 py-3 mb-5">
                        <p className="text-sm text-foreground leading-relaxed">
                            <span className="font-semibold">Authorized workspace access</span> is required.
                            Use this portal only for approved business workflows and follow your organization's
                    ...
                    >
                        ...
                        <p className="mb-3">
                            Access to {displayName} is granted to authorized users only. You must be employed by
                            or acting on behalf of the customer organization. Sharing credentials is strictly prohibited.
                        </p>
                        ...
                        <p className="mb-2">
                            Data accessed through this platform may be confidential. You agree to:
                        </p>
                        <ul className="list-disc pl-5 mb-3 space-y-1">
                            ...
                            <li>Comply with applicable laws, contracts, and your organization's policies.</li>
                        </ul>
                        ...
                        <p className="mb-3">
                            Reports, summaries, and workflow outputs are for operational support only. They do not
                            replace user review, internal approval, or professional judgment. Final decisions remain
                            the responsibility of the user and their organization.
                        </p>
                        ...
                        <p className="mb-3">
                            Your organization retains ownership of submitted records and operational data. The
                            platform may process aggregated technical telemetry to improve reliability and performance.
                        </p>
                        ...
                        <p className="mb-3">
                            The platform provider is not liable for business loss, revenue loss, or third-party
                            decisions made outside the platform. Liability is limited to fees paid in the preceding
                            12 months unless a separate agreement states otherwise.
                        </p>
                    ...
                    <label className="flex items-start gap-3 cursor-pointer group mb-5">
                        ...
                        <span className="text-sm text-muted-foreground leading-relaxed">
                            ...
                            <span className="font-semibold text-foreground">{displayName} Terms of Use</span>,
                            including data handling obligations, output review, and acceptable use policies.
                        </span>
                    </label>
                </div>
                ...
                <div className="px-6 py-4 border-t border-border/50 bg-muted/20 shrink-0">
                    ...
                    <p className="text-center text-xs text-muted-foreground/60 mt-3">
                        Effective {new Date().toLocaleDateString("en-US", { year: "numeric", month: "long", day: "numeric" })} &middot; {displayName} &middot; Questions? {supportEmail}
                    </p>
                </div>
            </div>
        </div>

...
if (!envResult.success) {
    ...
    console.warn(`[portal-admin-v2] Missing environment variables: ${envResult.error.issues.map(i => i.message).join(", ")}. Copy .env.example to .env and fill in your Supabase credentials.`)
}
